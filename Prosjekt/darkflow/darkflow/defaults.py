class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('dataset', 'FaceDataset/annotation/images', 'path to dataset directory')
        ...
        self.define('annotation', 'FaceDataset/annotation', 'path to annotation directory')
        ...
        self.define('lr', 1e-8, 'learning rate')
